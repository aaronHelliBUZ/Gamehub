function script(aepfel){
    ...
    function bewegen(){
        ...
        if(x == 0 && richtung[richtungLaenge] == 'A' || x == 19 && richtung[richtungLaenge] == 'D' || y == 0 && richtung[richtungLaenge] == 'W' || y == 14 && richtung[richtungLaenge] == 'S'){
            sterben();
        }
